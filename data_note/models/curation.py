...
class ExtractionInfo:
    ...
    extraction_name: Any = None
    extraction_type: Any = None
    extraction_qc_result: Any = None
    extraction_fluidx_id: Any = None
    ...
    tissue_prep_name: Any = None
    tissue_prep_date: Any = None
    tissue_prep_type: Any = None
    tissue_prep_fluidx_id: Any = None
    tissue_prep_fluidx_container_id: Any = None
    tissue_prep_downstream_protocol: Any = None
    tissue_prep_sciops_protocol_required: Any = None
