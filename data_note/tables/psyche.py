...
def make_table5_rows(context):
    ...
    software_list = [
        ...
        ("lep_busco_painter", software_version(context, "lep_busco_painter_version", "1.0.0"), "[https://github.com/charlottewright/lep_busco_painter](https://github.com/charlottewright/lep_busco_painter)"),
