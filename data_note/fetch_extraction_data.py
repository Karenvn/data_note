...
def get_sequencing_and_extraction_metadata(sanger_sample_id):
    ...
    if seq_request:
        ...
        seq_attrs_renamed = {
            ...
            "spri_type": seq_attrs.get("benchling_spri_type"),
            "bead_type": seq_attrs.get("benchling_bead_type"),
            "qubit_ngul": seq_attrs.get("benchling_post_spri_concentration_ngul"),
            "nanodrop_concentration_ngul": seq_attrs.get("benchling_nanodrop_concentration_ngul"),
            "ratio_260_280": seq_attrs.get("benchling_nanodrop_260280"),
            "ratio_260_230": seq_attrs.get("benchling_nanodrop_260230"),
            "fragment_size_kb": format_kb(seq_attrs.get("benchling_sheared_femto_fragment_size_bp")),
